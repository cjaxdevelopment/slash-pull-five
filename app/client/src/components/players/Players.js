        ...
        {players.map(player => (
          ...
          >
              ...
              {editingPlayer && editingPlayer._id === player._id ? (
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setEditingPlayer({ ...editingPlayer, class: e.target.value })}
                    className="border p-2 mr-2 rounded"
                  >
                    {classOptions.map(option => (
                      <option key={option.value} value={option.value}>
                  ...
                  <select
                    value={editingPlayer.spec}
                    onChange={(e) => setEditingPlayer({ ...editingPlayer, spec: e.target.value })}
                    className="border p-2 mr-2 rounded"
                  >
                    {availableSpecs.map(option => (
                      <option key={option.value} value={option.value}>
                  ...
                  <select
                    value={editingPlayer.offspec}
                    onChange={(e) => setEditingPlayer({ ...editingPlayer, offspec: e.target.value })}
                    className="border p-2 mr-2 rounded"
                  >
                    {availableSpecs.map(option => (
                      <option key={option.value} value={option.value}>
            ...
            <div className="flex space-x-2">
              ...
              <button
                onClick={() => setEditingPlayer({ _id: player._id, name: player.name, role: player.role, class: player.class, spec: player.spec, offspec: player.offspec })}
