  ...
  return (
    ...
    >
      <div className="flex items-center space-x-2">
        <img src={roleIcons[player.role]} alt={player.role} className="w-6 h-6" />
        <span className="pl-4 font-bold">{player.name}</span>
      </div>
      <div className="flex items-center space-x-2">
        <img src={classIcons[player.class]} alt={player.class} className="w-6 h-6" />
        <img src={specIcons[player.spec]} alt={player.spec} className="w-6 h-6" />
        <img src={specIcons[player.offspec]} alt={player.offspec} className="w-6 h-6" />
      </div>
    </div>
  );
};
